...
namespace Be.HexEditor
{
    public partial class FormOptions : Form //Core.FormEx
    {
        ...
        public FormOptions()
        {
            ...
            dt.Rows.Add(ResStrings.English, "en");
            dt.Rows.Add(ResStrings.German, "de");
			dt.Rows.Add(ResStrings.Italian, "it");
            dt.Rows.Add(ResStrings.Japanese, "ja");
            dt.Rows.Add(ResStrings.Russian, "ru");
            dt.Rows.Add(ResStrings.SimplifiedChinese, "zh-CN");
        ...
        void okButton_Click(object sender, EventArgs e)
        {
                ...
                Settings.Default.SelectedLanguage != (string)this.languageComboBox.SelectedValue)
            {
                ...
                Program.ShowMessage(ResStrings.ProgramRestartSettings);
